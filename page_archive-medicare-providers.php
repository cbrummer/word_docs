<?php
/**
 * Template name: Medicare Providers
 *
 *
...
add_action( 'genesis_loop', 'custom_do_medicare_providers_loop' );

function custom_do_medicare_providers_loop() {
