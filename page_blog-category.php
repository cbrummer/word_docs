<?php 
/**
 * Template Name: Page of Posts Archive
 * ADC Twenty Thirteen
 *
 * Description: Archive that allows you to define posts from certain category through custom field in page. This will display a thumbnail with each excerpt. 
 *
